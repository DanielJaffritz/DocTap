...
export default function DeleteDialog({ isOpen, setIsOpen, docId, optimistic }: dialogProps) {
  ...
  return (
    <dialog open closedby="any" onClose={() => setIsOpen(false)} className="bg-background p-10 items-center border border-border transition-all rounded-2xl shadow-2xl flex flex-col w-1/2 fixed top-[50%] left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%]">
